...
class DiscontinuousExcitationControlUserDefined(DiscontinuousExcitationControlDynamics, ModuleType):
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        return DiscontinuousExcitationControlUserDefined(*args, **kwargs)
...
# makes:
# "import DiscontinuousExcitationControlUserDefined"
# work as well as
# "from DiscontinuousExcitationControlUserDefined import DiscontinuousExcitationControlUserDefined".
# You would get a typechecker "not callable" error, but this might be useful for
# backward compatibility.
sys.modules[__name__].__class__ = DiscontinuousExcitationControlUserDefined
