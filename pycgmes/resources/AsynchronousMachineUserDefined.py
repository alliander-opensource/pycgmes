...
class AsynchronousMachineUserDefined(AsynchronousMachineDynamics, ModuleType):
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        return AsynchronousMachineUserDefined(*args, **kwargs)
...
# makes:
# "import AsynchronousMachineUserDefined"
# work as well as
# "from AsynchronousMachineUserDefined import AsynchronousMachineUserDefined".
# You would get a typechecker "not callable" error, but this might be useful for
# backward compatibility.
sys.modules[__name__].__class__ = AsynchronousMachineUserDefined
