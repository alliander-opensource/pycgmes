...
class TurbineGovernorUserDefined(TurbineGovernorDynamics, ModuleType):
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        return TurbineGovernorUserDefined(*args, **kwargs)
...
# makes:
# "import TurbineGovernorUserDefined"
# work as well as
# "from TurbineGovernorUserDefined import TurbineGovernorUserDefined".
# You would get a typechecker "not callable" error, but this might be useful for
# backward compatibility.
sys.modules[__name__].__class__ = TurbineGovernorUserDefined
