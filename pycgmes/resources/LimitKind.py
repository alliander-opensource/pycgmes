...
class LimitKind(str, Enum):
    ...
    highVoltage = "highVoltage"  # Referring to the rating of the equipments, a voltage too high can lead to accelerated ageing or the destruction of the equipment.  This limit type may or may not have duration.  # noqa: E501, E741, RUF003
    lowVoltage = "lowVoltage"  # A too low voltage can disturb the normal operation of some protections and transformer equipped with on-load tap changers, electronic power devices or can affect the behaviour of the auxiliaries of generation units. This limit type may or may not have duration.  # noqa: E501, E741, RUF003
    operationalVoltageLimit = "operationalVoltageLimit"  # Operational voltage limit.  # noqa: E501, E741, RUF003
    alarmVoltage = "alarmVoltage"  # Voltage alarm.  # noqa: E501, E741, RUF003
    warningVoltage = "warningVoltage"  # Voltage warning.  # noqa: E501, E741, RUF003
    stability = "stability"  # Stability.  # noqa: E501, E741, RUF003
