...
class PowerSystemStabilizerUserDefined(PowerSystemStabilizerDynamics, ModuleType):
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        return PowerSystemStabilizerUserDefined(*args, **kwargs)
...
# makes:
# "import PowerSystemStabilizerUserDefined"
# work as well as
# "from PowerSystemStabilizerUserDefined import PowerSystemStabilizerUserDefined".
# You would get a typechecker "not callable" error, but this might be useful for
# backward compatibility.
sys.modules[__name__].__class__ = PowerSystemStabilizerUserDefined
