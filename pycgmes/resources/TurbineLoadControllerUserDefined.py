...
class TurbineLoadControllerUserDefined(TurbineLoadControllerDynamics, ModuleType):
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        return TurbineLoadControllerUserDefined(*args, **kwargs)
...
# makes:
# "import TurbineLoadControllerUserDefined"
# work as well as
# "from TurbineLoadControllerUserDefined import TurbineLoadControllerUserDefined".
# You would get a typechecker "not callable" error, but this might be useful for
# backward compatibility.
sys.modules[__name__].__class__ = TurbineLoadControllerUserDefined
