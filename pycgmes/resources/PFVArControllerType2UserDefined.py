...
class PFVArControllerType2UserDefined(PFVArControllerType2Dynamics, ModuleType):
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        return PFVArControllerType2UserDefined(*args, **kwargs)
...
# makes:
# "import PFVArControllerType2UserDefined"
# work as well as
# "from PFVArControllerType2UserDefined import PFVArControllerType2UserDefined".
# You would get a typechecker "not callable" error, but this might be useful for
# backward compatibility.
sys.modules[__name__].__class__ = PFVArControllerType2UserDefined
