...
class OverexcitationLimiterUserDefined(OverexcitationLimiterDynamics, ModuleType):
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        return OverexcitationLimiterUserDefined(*args, **kwargs)
...
# makes:
# "import OverexcitationLimiterUserDefined"
# work as well as
# "from OverexcitationLimiterUserDefined import OverexcitationLimiterUserDefined".
# You would get a typechecker "not callable" error, but this might be useful for
# backward compatibility.
sys.modules[__name__].__class__ = OverexcitationLimiterUserDefined
