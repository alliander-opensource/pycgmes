...
class VoltageCompensatorUserDefined(VoltageCompensatorDynamics, ModuleType):
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        return VoltageCompensatorUserDefined(*args, **kwargs)
...
# makes:
# "import VoltageCompensatorUserDefined"
# work as well as
# "from VoltageCompensatorUserDefined import VoltageCompensatorUserDefined".
# You would get a typechecker "not callable" error, but this might be useful for
# backward compatibility.
sys.modules[__name__].__class__ = VoltageCompensatorUserDefined
