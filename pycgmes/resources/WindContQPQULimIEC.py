...
class WindContQPQULimIEC(IdentifiedObject, ModuleType):
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        return WindContQPQULimIEC(*args, **kwargs)
...
# makes:
# "import WindContQPQULimIEC"
# work as well as
# "from WindContQPQULimIEC import WindContQPQULimIEC".
# You would get a typechecker "not callable" error, but this might be useful for
# backward compatibility.
sys.modules[__name__].__class__ = WindContQPQULimIEC
